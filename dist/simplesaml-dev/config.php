...
/* NOTE: taken and modified from https://github.com/simplesamlphp/simplesamlphp/blob/master/config/config.php.dist */
...
$config = [
     ...
     * root directory.
     */
    // 'cachedir' => $library_root . \DIRECTORY_SEPARATOR . 'cache',
    'cachedir' => $library_root . \DIRECTORY_SEPARATOR . 'cache',
    //'loggingdir' => '/var/log/',
    //'datadir' => '/var/data/',
    ...
    */
    ...
    'session.phpsession.savepath' => $library_root . \DIRECTORY_SEPARATOR . 'sessions',
